...
import com.meddjamm.sn.assembler.CSVExportAssembler;
...
public class PatientController implements PatientApi {
    ...
    public ResponseEntity<PatientDetailDs> findPatientByIndex(String index) {
        PatientDetailDs patientResult = patientAssembler.assemblePatientDetails(patientService.findByIndex(index));
        return new ResponseEntity<>(patientResult, HttpStatus.OK);
    }
