...
import com.meddjamm.sn.repository.RendezVousRepository;
...
public class RendezVousServiceImpl implements RendezVousService {
    ...
    public RendezVous updateRendezVous(Long id, RendezVous rendezVous) throws Exception {
        ...
        rendezVousResult.setNumeroRendezVous(rendezVous.getNumeroRendezVous());
        rendezVousResult.setDateRendezVous(rendezVous.getDateRendezVous());
        rendezVousResult.setHeure(rendezVous.getHeure());
        rendezVousResult.setIndex(rendezVous.getIndex());
        rendezVousResult.setCreateDate(rendezVous.getCreateDate());
        rendezVousResult.setEtat(rendezVous.getEtat());
        rendezVousResult.setActif(rendezVous.isActif());
