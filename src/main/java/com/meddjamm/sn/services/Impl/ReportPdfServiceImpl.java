...
import com.meddjamm.sn.assembler.PDFExportAssembler;
...
//            table.addCell(cell);
            ...
            cell.setPhrase(new Phrase(item.getIndex(), getFontContent()));
            table.addCell(cell);

            cell.setPhrase(new Phrase(valueOf(item.getDateInscription()), getFontContent()));
            table.addCell(cell);
