...
VALUES (1, 'TYPE_PHOTO_PAT', 'Photo du patient', 1),
       ...
       (3, 'TYPE_EXAM_CONS_BIO', 'Consultation biologie',1),
       (4, 'TYPE_EXAM_CONS_IMMUNO', 'Consultation immunologie',1),
       (5, 'TYPE_EXAM_CONS_IMG', 'Consultation imagerie',1),
       (6, 'TYPE_EXAM_CONS_ANA', 'Consultation Anato',1),
       (7, 'TYPE_EXAM_BIO_COMP', 'Examen biologie',1),
       (8, 'TYPE_EXAM_IMMUNO_COMP', 'Examen immunologie',1),
       (9, 'TYPE_EXAM_IMG_COMP', 'Examen imagerie',1),
       (10, 'TYPE_EXAM_ANA_COMP', 'Examen Anato',1);
